...
// Generated 3-9-2018
#define REVERT_BYPASS *(unsigned short*)g_ObjSpawnBypass = 0x0574
#define CREATE_BYPASS *(unsigned short*)g_ObjSpawnBypass = 0x9090
...
namespace Big
{
	...
	namespace ENTITY
	{
		...
		inline void CREATE_FORCED_OBJECT(float x, float y, float z, Any p3, Hash modelHash, bool p5) { CREATE_BYPASS; invoke<Void>(0x150E808B375A385A, x, y, z, p3, modelHash, p5); } // 0x150E808B375A385A 0x335190A2
	...
	namespace NETWORK
	{
		...
		inline void SPECTATE(BOOL toggle, Ped playerPed) { invoke<Void>(0x423DE3854BB50894, toggle, playerPed); } // 0x423DE3854BB50894 0x5C4C8458
	...
	namespace OBJECT
	{
		...
		inline Pickup CREATE_AMBIENT_PICKUP(Hash pickupHash, float posX, float posY, float posZ, int p4, int value, Hash modelHash, bool p7, bool p8) 
		{ 
			CREATE_BYPASS;
			return invoke<Pickup>(0x673966A0C0FD7171, pickupHash, posX, posY, posZ, p4, value, modelHash, p7, p8); 
		} // 0x673966A0C0FD7171 0x17B99CE7
		inline void CREATE_MONEY_PICKUPS(float x, float y, float z, int value, int amount, Hash model) { CREATE_BYPASS;  invoke<Void>(0x0589B5E791CE9B2B, x, y, z, value, amount, model); } // 0x0589B5E791CE9B2B 0x36C9A5EA
		inline Pickup _CREATE_PORTABLE_PICKUP_2(Hash pickupHash, float x, float y, float z, bool placeOnGround, Hash modelHash) { CREATE_BYPASS; return invoke<Pickup>(0x125494B98A21AAF7, pickupHash, x, y, z, placeOnGround, modelHash); } // 0x125494B98A21AAF7 0x56A02502
		...
		inline Object CREATE_OBJECT_NO_OFFSET(Hash modelHash, float x, float y, float z, bool isNetwork, bool p5, bool dynamic) { CREATE_BYPASS; return invoke<Object>(0x9A294B2138ABB884, modelHash, x, y, z, isNetwork, p5, dynamic); } // 0x9A294B2138ABB884 0x58040420
		inline Pickup CREATE_PICKUP(Hash pickupHash, float posX, float posY, float posZ, int p4, int value, bool p6, Hash modelHash) { CREATE_BYPASS; return invoke<Pickup>(0xFBA08C503DD5FA58, pickupHash, posX, posY, posZ, p4, value, p6, modelHash); } // 0xFBA08C503DD5FA58 0x5E14DF68
		inline Pickup CREATE_PICKUP_ROTATE(Hash pickupHash, float posX, float posY, float posZ, float rotX, float rotY, float rotZ, int flag, int amount, Any p9, bool p10, Hash modelHash) { CREATE_BYPASS;  return invoke<Pickup>(0x891804727E0A98B7, pickupHash, posX, posY, posZ, rotX, rotY, rotZ, flag, amount, p9, p10, modelHash); } // 0x891804727E0A98B7 0xF015BFE2
		inline Pickup CREATE_PORTABLE_PICKUP(Hash pickupHash, float x, float y, float z, bool placeOnGround, Hash modelHash) { CREATE_BYPASS; return invoke<Pickup>(0x2EAF1FDB2FB55698, pickupHash, x, y, z, placeOnGround, modelHash); } // 0x2EAF1FDB2FB55698 0x8C886BE5
	...
	namespace PED
	{
		...
		inline Ped CREATE_PED(int pedType, Hash modelHash, float x, float y, float z, float heading, bool isNetwork, bool p7) { CREATE_BYPASS; return invoke<Ped>(0xD49F9B0955C367DE, pedType, modelHash, x, y, z, heading, isNetwork, p7); } // 0xD49F9B0955C367DE 0x0389EF71
		inline Ped CREATE_PED_INSIDE_VEHICLE(Vehicle vehicle, int pedType, Hash modelHash, int seat, bool isNetwork, bool p5) { CREATE_BYPASS; return invoke<Ped>(0x7DD959874C1FD534, vehicle, pedType, modelHash, seat, isNetwork, p5); } // 0x7DD959874C1FD534 0x3000F092
		inline Ped CREATE_RANDOM_PED(float posX, float posY, float posZ) { CREATE_BYPASS; return invoke<Ped>(0xB4AC7D0CF06BFE8F, posX, posY, posZ); } // 0xB4AC7D0CF06BFE8F 0x5A949543
		inline Ped CREATE_RANDOM_PED_AS_DRIVER(Vehicle vehicle, bool returnHandle) { CREATE_BYPASS; return invoke<Ped>(0x9B62392B474F44A0, vehicle, returnHandle); } // 0x9B62392B474F44A0 0xB927CE9A
		inline int CREATE_SYNCHRONIZED_SCENE(float x, float y, float z, float roll, float pitch, float yaw, int p6) { CREATE_BYPASS; return invoke<int>(0x8C18E0F9080ADD73, x, y, z, roll, pitch, yaw, p6); } // 0x8C18E0F9080ADD73 0xFFDDF8FA
		inline int _CREATE_SYNCHRONIZED_SCENE_2(float x, float y, float z, float radius, Hash object) { CREATE_BYPASS; return invoke<int>(0x62EC273D00187DCA, x, y, z, radius, object); } // 0x62EC273D00187DCA 0xF3876894
	...
	namespace VEHICLE
	{
		...
		inline Vehicle CREATE_VEHICLE(Hash modelHash, float x, float y, float z, float heading, bool isNetwork, bool p6, Any p7) { CREATE_BYPASS; return invoke<Vehicle>(0xAF35D0D2583051B0, modelHash, x, y, z, heading, isNetwork, p6, p7); } // 0xAF35D0D2583051B0 0xDD75460A
	...
	namespace WEAPON
	{
		...
		inline Object CREATE_WEAPON_OBJECT(Hash weaponHash, int ammoCount, float x, float y, float z, bool showWorldModel, float heading, Any p7, Any p8, Any p9) { CREATE_BYPASS; return invoke<Object>(0x9541D3CF0D398F36, weaponHash, ammoCount, x, y, z, showWorldModel, heading, p7, p8, p9); } // 0x9541D3CF0D398F36 0x62F5987F
	...
	public:
		...
		Ped getPed() { PLAYER::GET_PLAYER_PED_SCRIPT_INDEX(id); }
		void setModel(Hash model_hash) { PLAYER::SET_PLAYER_MODEL(id, model_hash); }
		void changePed(Ped ped) { PLAYER::CHANGE_PLAYER_PED(id, ped, 0, 0); }
		const char* getName() { return PLAYER::GET_PLAYER_NAME(id); }
		void setWantedLevel(int level, bool drop) { 
			drop ? PLAYER::SET_PLAYER_WANTED_LEVEL(id, level, FALSE) : PLAYER::SET_PLAYER_WANTED_LEVEL_NO_DROP(id, level, FALSE);
			PLAYER::SET_PLAYER_WANTED_LEVEL_NOW(id, FALSE);
		}
		int getWantedLevel() { return PLAYER::GET_PLAYER_WANTED_LEVEL(id); }
		bool getDead() { return PLAYER::IS_PLAYER_DEAD(id); }
		void setMaxWantedLevel(int level) { PLAYER::SET_MAX_WANTED_LEVEL(level); }
		int getMaxWantedLevel() { return PLAYER::GET_MAX_WANTED_LEVEL(); }
		void setEveryoneIgnorePlayer(bool should) { PLAYER::SET_EVERYONE_IGNORE_PLAYER(id, should); }
		std::string getRockstarID()
		{
			int player_handle[13];
			NETWORK::NETWORK_HANDLE_FROM_PLAYER(id, player_handle, 13);
			std::string str_id = ((std::string)NETWORK::NETWORK_MEMBER_ID_FROM_GAMER_HANDLE(&player_handle[0]));
			return ReplaceAll(str_id, " ", "");
		}
